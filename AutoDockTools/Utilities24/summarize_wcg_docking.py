...
# 
#
# $Header: /opt/cvs/python/packages/share1.5/AutoDockTools/Utilities24/summarize_wcg_docking.py,v 1.3.10.1 2016/02/11 09:24:08 annao Exp $
#
...
if __name__ == '__main__':
    ...
    if print_best_only:
        ...
        if report_energy_breakdown:
            ...
            total_score = numpy.add.reduce(score_list) + c.internal_energy + tors_penalty
            #total_score = numpy.add.reduce(score_list)
