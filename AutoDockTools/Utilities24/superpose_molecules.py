...
if __name__ == '__main__':
    ...
    def usage():
        ...
        print(
            "   The number of entries in the comma-separated lists must be the same for each entry (and more than 2) ")
    ...
    for l in lines[1:]:
        ...
        if num_moving_ats != num_ref_ats:
            print("Number of moving_ats (%d) does not match number of reference atoms (%d). Skipping %s" % (
