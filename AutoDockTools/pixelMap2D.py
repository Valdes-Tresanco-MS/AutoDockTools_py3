...
#
# $Id: pixelMap2D.py,v 1.4.10.1 2016/02/11 09:24:08 annao Exp $
...
##import numpy
##ligand_results = numpy.array(all_ligand_results)
...
##now ligand_results are #[[lig1]
                         ...
                         #[lig4]
                         #...]
##receptor_results = numpy.array(all_receptor_results)
