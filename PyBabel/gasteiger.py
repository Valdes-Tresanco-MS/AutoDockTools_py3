...
#                                                                                                  #
#  Modification date: 10/5/20 22:11                                                                #
#                                                                                                  #
# ##################################################################################################
...
class Gasteiger:
    ...
    def calc_sigma_charges(self, atoms):
        ...
        while True:
                ...
                if a._gast_par[3] != 1.0:
                    ...
                    for b in a.bonds:
                        ...
                        if a2._gast_par[3] != 1.0:
                            ...
                            if a2.babel_type == 'H':
                                hybridD = 20.02
                            a.gast_charge = a.gast_charge + (a2._xx - a._xx) / hybridD * z1
            ...
            if d1 >= 0.001:
                for a in atoms:
                    a._xx = (a._gast_par[0] + a._gast_par[1] * a.gast_charge + a._gast_par[2] * a.gast_charge *
                             a.gast_charge)
            cycle = cycle + 1
